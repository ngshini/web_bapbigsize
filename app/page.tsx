        ...
        <section className="bg-brand-50">
          <div className="mx-auto grid max-w-6xl gap-8 px-4 py-8 md:grid-cols-[1fr_0.92fr] md:items-center md:py-12">
            <div className="order-2 md:order-1">
              ...
              <h1 className="max-w-2xl text-3xl font-bold leading-tight text-brand-900 sm:text-4xl md:text-5xl">Set đồ bộ thiết kế cao cấp ,dễ mặc , lên form đẹp, đặt hàng nhanh</h1>
